...
const PaymentInStoreVerifyDni = () => {
  ...
  const goOperationComplete = () => {
    navigation.navigate(
      getRoutePath(HOME_ROUTE.PaymentInStoreOperationComplete, HOME_ROUTE),
  ...
  const goOperationRejected = () => {
    navigation.navigate(
      getRoutePath(HOME_ROUTE.PaymentInStoreDniRejected, HOME_ROUTE),
    );
  };
          ...
          <CenteredContainer style={{ flex: 1, justifyContent: 'center' }}>
            <View>
              ...
              <Subtitle>
                ...
                solicitamos presente su DNI. Una vez verificada su
                identidad se confirmará la compra.
              </Subtitle>
            </View>
          </CenteredContainer>
        </InfoPanel>
...
PaymentInStoreVerifyDni.navigationOptions = {
  header: null,
};

export default PaymentInStoreVerifyDni;
