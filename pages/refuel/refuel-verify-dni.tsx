...
const RefueleVerifyDni = () => {
  ...
  const goOperationComplete = () => {
    navigation.navigate(
      getRoutePath(HOME_ROUTE.RefuelOperationComplete, HOME_ROUTE),
      { operationId: operationId, pumpId: pumpId },
    );
  };

  const goOperationRejected = () => {
    navigation.navigate(
      getRoutePath(HOME_ROUTE.RefuelDniRejected, HOME_ROUTE),
    );
  };
...
RefueleVerifyDni.navigationOptions = {
  header: null,
};

export default RefueleVerifyDni;
